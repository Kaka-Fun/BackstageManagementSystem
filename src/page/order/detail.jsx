/*
 * @Author: wyatt 
 * @Date: 2018-07-17 21:11:05 
 * @Last Modified by: wyatt
 * @Last Modified time: 2018-07-17 22:29:48
 */
                ...
                <div className="form-horizontal">
                    <div className="form-group">
                        ...
                        <div className="col-md-5">
                            <p readOnly className="form-control-static">{this.state.orderInfo.orderNo}</p>
                        </div>
                    </div>
                    <div className="form-group">
                        <label className="col-md-2 control-label">创建时间</label>
                        <div className="col-md-5">
                            <p readOnly className="form-control-static" >{this.state.orderInfo.createTime}</p>
                        </div>
                    </div>
                    <div className="form-group">
                        <label className="col-md-2 control-label">收件人</label>
                        <div className="col-md-5">
                            <p readOnly className="form-control-static" >
                    ...
                    <div className="form-group">
                        ...
                        <div className="col-md-5">
                            <p readOnly className="form-control-static" >￥{this.state.orderInfo.payment}</p>
                        </div>
                    </div>
                    <div className="form-group">
