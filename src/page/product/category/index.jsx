/*
 * @Author: wyatt 
 * @Date: 2018-07-16 16:57:36 
 * @Last Modified by: wyatt
 * @Last Modified time: 2018-07-17 00:22:33
 */
...
export default class CategoryList extends React.Component{
    constructor(props){
        super(props);
        this.state={
            parentCategoryId : this.props.match.params.catrgoryId || 0,
            list: [],
        }
    }
    componentDidMount(){
    ...
    // 加载品类列表
    loadGategoryIdList(){
        _product.getCatrgoryList(this.state.parentCategoryId).then((res)=>{
            this.setState({
                list: res
            })
        }, (errMsg)=>{
    ...
    onUpdateName(categoryId, categoryName){
        let newName = window.prompt('请输入新的品类名字', categoryName)
        if (newName) {
